...
var K=Object.defineProperty;var tt=Object.getOwnPropertyDescriptor;var et=Object.getOwnPropertyNames;var it=Object.prototype.hasOwnProperty;var ot=(a,i)=>{for(var t in i)K(a,t,{get:i[t],enumerable:!0})},st=(a,i,t,e)=>{if(i&&typeof i=="object"||typeof i=="function")for(let o of et(i))!it.call(a,o)&&o!==t&&K(a,o,{get:()=>i[o],enumerable:!(e=tt(i,o))||e.enumerable});return a};var nt=a=>st(K({},"__esModule",{value:!0}),a);var at={};ot(at,{default:()=>_});module.exports=nt(at);var w=require("obsidian");var G={recordingFolder:"vmemo-recordings",keepAudioFiles:!0,audioFormat:"wav",voxmlxPath:"",voxmlxModel:"mlx-community/Voxtral-Mini-4B-6bit",transcriptionLanguage:"auto",aiProvider:"anthropic",autoFormat:!0,anthropicKey:"",anthropicModel:"claude-sonnet-4-20250514",openaiKey:"",openaiModel:"gpt-4.1",googleKey:"",googleModel:"gemini-2.5-pro",xaiKey:"",xaiModel:"grok-3",defaultTemplate:"meeting-notes",customTemplates:{},maxRecordingDuration:120,showNotifications:!0,debugMode:!1},m={anthropic:{model:"claude-sonnet-4-20250514",name:"Claude Sonnet 4",endpoint:"https://api.anthropic.com/v1/messages",maxTokens:8192},openai:{model:"gpt-4.1",name:"GPT-4.1",endpoint:"https://api.openai.com/v1/chat/completions",maxTokens:8192},google:{model:"gemini-2.5-pro",name:"Gemini 2.5 Pro",endpoint:"https://generativelanguage.googleapis.com/v1beta/models",maxTokens:8192},xai:{model:"grok-3",name:"Grok 3",endpoint:"https://api.x.ai/v1/chat/completions",maxTokens:8192}},j={sampleRate:16e3,channelCount:1,bitDepth:16,mimeType:"audio/webm;codecs=opus",targetFormat:"wav",maxFileSizeMB:500},T={voxmlxCommand:"voxmlx",checkCommand:"voxmlx --version",installCommand:"pipx install voxmlx --python python3.11",pythonVersion:"3.11",supportedFormats:["wav","mp3","m4a","flac","ogg","webm"],defaultLanguage:"auto"},p={"meeting-notes":{id:"meeting-notes",name:"Meeting Notes",description:"Structured meeting minutes with action items",icon:"users",content:`# Meeting Notes: {{title}}
